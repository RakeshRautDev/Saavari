    ...
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <img className='h-20' src={props.image[props.selectedVehicle]} alt="" />
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3'>
                        ...
                        <div>
<h3 className='text-lg font-medium'>₹{props.fare[props.selectedVehicle]}</h3>                            <p className='text-sm -mt-1 text-gray-600'>Cash Cash</p>
                        </div>
                    </div>
                </div>
            </div>
